...
#ifndef CY8C6247BZI_D54
    #error "Unexpected target MCU; expected CY8C6247BZI-D54. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif
#endif
